package Iteration1.Sprint5;//To keep track of its customers, Wat-a-Pizza wishes to store the details of its customer in its database. Write a
...
public class WatAPizzaMainMethod
{
    public static void main(String[] args)
    {
        ...
        double priceOfRegPizza= 9.99, priceOfMedPizza= 11.99, priceOfLgPizza= 13.99, priceOfGarlicBread= 5.99, priceOfBeverage= 1.99;
        char size='M';
        ...
        orderSummary= (float)((priceOfRegPizza*noOfPizzasOrdered) + (priceOfGarlicBread*noOfGarlicBreadOrdered) + (priceOfBeverage*noOfBeveragesOrdered));
        //-----------------------Logic Ends----------------------------------------------------------------------------
        ...
        if(choice==1) {
            System.out.println("Your total pizza amount is $" + (priceOfRegPizza*noOfPizzasOrdered));
        } else if(choice==2){
        ...
        System.out.println("To display the pricing for each product, please enter 1 for pizza, 2 for garlic bread and 3 for beverage");
                int pickOption = x.nextInt();
                switch(pickOption)
                {
                    case 1:
                        System.out.println("The price of pizza is " +priceOfRegPizza);
                        break;
                    case 2:
